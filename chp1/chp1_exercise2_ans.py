...
combined_data['adj_factor'] = combined_data['adj_factor'][combined_data['close_price'].columns]
combined_data['adj_close'] = combined_data['adj_factor'] * combined_data['close_price']
