...
n_factors = 50  # Number of factors to extract
fa = FactorAnalysis(n_components=n_factors, random_state=42)
X_factors = fa.fit_transform(X_train_flat)

# Get factor loadings (components)
loadings = fa.components_  # Shape: (n_factors, 784)
...
# Reconstruct data
X_reconstructed = X_factors @ loadings + fa.mean_  # Mean-centered reconstruction
